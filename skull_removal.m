...
baseFileName = 'Small periventircular hemorrhage with intraventricular extension.jpg';
a=baseFileName;
...
title('Hemorrage Lesion Detection');


%===========================================================================================================
% Pseudo Color Image Result

a=imread('Small periventircular hemorrhage with intraventricular extension.jpg');
...
title('Hemorrage_Lesion_Highlighted');
